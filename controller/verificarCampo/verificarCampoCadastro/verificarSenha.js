    ...
    if (
      ...
      if (passwords[0].value != "" && passwords[1].value != "") {
        ...
        if (passwords[0].value == passwords[1].value) {
          ...
          msgs[0].innerHTML =
            '<font color="#27ae60"><b>Senhas Iguáis!</b></font>';
          msgs[1].innerHTML =
            '<font color="#27ae60"><b>Senhas Iguáis!</b></font>';
        ...
        msgs[index].innerHTML =
          '<font color="#27ae60"><b>Senha Válida!</b></font>';
        senha.style = "box-shadow: 1px 2px 3px #2ecc71;";
      }
    } else {
      msgs[index].innerHTML =
        '<font color="#e74c3c"><b>Senha Inválida! (Necessário 8+ Caracteres Alfanumericos)</b></font>';
    ...
    if (
      ...
      if (passwords[0].value != "" && passwords[1].value != "") {
        if (passwords[0].value == passwords[1].value) {
          ...
          msgs[0].innerHTML =
            '<font color="#842029"><b>Senhas Diferentes!</b></font>';
          msgs[1].innerHTML =
            '<font color="#842029"><b>Senhas Diferentes!</b></font>';
          passwords[0].style = "box-shadow: 1px 2px 3px #e74c3c;";
          passwords[1].style = "box-shadow: 1px 2px 3px #e74c3c;";
