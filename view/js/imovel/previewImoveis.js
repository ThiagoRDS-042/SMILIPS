  ...
  if (files) {
    ...
    if (
      ...
      if ((files.length > 2 && files.length < 11) || files.length == 0) {
        ...
        location =
          "/SMILIPS/controller/imovel/imovelDAO.php?notificacao_imgs=Número de Imagens Selecionadas Inválido!";
      }
    } else {
      location =
        "/SMILIPS/controller/imovel/imovelDAO.php?notificacao_imgs=Formato ou Tamanho de Arquivo Inválido!";
    }
